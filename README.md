...
- Recommending restaurants based on input food type (e.g., Japanese, Chinese, Vegetarian) with machine generated comments
- Predicting and rating user's review automatically
